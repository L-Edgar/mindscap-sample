...
import shap from '../../img/shap.svg'
import white2bg from '../../img/white2bg.png'
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-50 w-full">
              <a
                ...
                className="mb-4 inline-block max-w-[160px]"
              >
                <img
                  src={white2bg}
                  alt="logo"
              ...
              <p className="mb-4 max-w-[270px] text-base text-white">
            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
                    class="mb-3 inline-block text-base text-white hover:text-primary"
                  >
                    LineIcons
                  </a>
                </li>
            ...
            <div className="mb-10 w-full">
              ...
              <div className="flex flex-col gap-8">
                ...
                >
                  ...
                  <span
                    className="max-w-[180px] text-base text-white group-hover:text-white"
                  >
